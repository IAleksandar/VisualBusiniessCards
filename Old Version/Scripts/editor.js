...
function changeTemplates() { // Аn empty function, previously added if I remove it, spoils the design of the card
    console.log("changed");
}

//    ===============================  font style  ============================
function italics() { // Changed Italics -> works
...
function bolds() { // Changed Bolds -> works
    if (lastClicked.id == 'nameInput') {
...
function underlines() { // Changed Underlines -> works
    if (lastClicked.id == 'nameInput') {
...
function uppercases() { // Changed Uppercases -> works
    if (lastClicked.id == 'nameInput') {
